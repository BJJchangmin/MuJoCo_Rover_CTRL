...
class TerrainGenerator:
    ...
    def AddPerlinHeighField(
        ...
        cv2.imwrite("assets/meshes/" + output_hfield_image,
                    terrain_image)
...
if __name__ == "__main__":
    ...
    # Perlin heigh field
    tg.AddPerlinHeighField(position=[0.04735, -1.09, -0.1],
    size=[50, 50],
    height_scale=0.08,
    smooth=45.0,
    perlin_octaves=5,
